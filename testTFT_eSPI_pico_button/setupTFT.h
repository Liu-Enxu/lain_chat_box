...
void readbinRTOS(){
  ...
  xTaskCreate(SDTask, "SD_Task", 6144, nullptr, configMAX_PRIORITIES - 1, &SD_Task_Handle);
  xTaskCreate(TFTTask, "TFT_Task", 6144, nullptr, configMAX_PRIORITIES - 2, &TFT_Task_Handle);
